...
urlpatterns = patterns('',
    ...
    url(r'^thread/(?P<thread>[0-9]+)/$', MyThreadListView, name='forum_view_thread'),
    ...
    url(r'^(?P<slug>[-\w]+)/$', MyForumListView(), name='forum_thread_list'),
    url(r'^(?P<forum>[-\w]+)/new/$', 'forum.views.newthread', name='forum_new_thread'),

    url(r'^([-\w/]+/)(?P<forum>[-\w]+)/new/$', 'forum.views.newthread'),
    url(r'^([-\w/]+/)(?P<slug>[-\w]+)/$', MyForumListView(), name='forum_subforum_thread_list'),
